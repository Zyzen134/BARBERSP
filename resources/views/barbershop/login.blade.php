...
<head>
    ...
    <title>Mr.Cut Cheap | Login</title>
    <style>
        :root {
            --sand: #f6efe7;
            --cream: #fff8f1;
    ...
    <div class="shell">
        ...
        <div class="wrap">
            <div>
                ...
                <p>Login untuk melihat riwayat booking, promo, dan mempercepat proses jadwal.</p>
            </div>
            <form class="panel" onsubmit="event.preventDefault(); localStorage.setItem('barbershop_user','1'); window.location.href='/barbershop';">
                ...
                <a class="btn secondary" href="/register">Belum punya akun? Register</a>
            </form>
        </div>
    </div>
</body>
